...
function player.load()
    ...
    player.exp = 0
    player.g = 0
    player.weapon = "toy_knife" -- only stick, the knifes, and tough_glove are implemented so far -- stick, toy_knife, tough_glove, ballet_shoes, torn_notebook, burnt_pan, empty_gun, frying_pan, real_knife 
