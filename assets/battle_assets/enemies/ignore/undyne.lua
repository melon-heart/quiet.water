...
function enemy.load()
    ...
    "* Undyne is here!/n* She looks very determined.",
    "* Undyne is here!/n* She looks even more determined.",
    "* Undyne is here!/n* She looks extremely determined.",
    "* Undyne is here!/n* She looks super ultra mega determined.",
    }
end
...
function enemy.draw()
    ...
    love.graphics.draw(enemy.ponytail, enemy.ponytail_quads[enemy.ponytail_frame], 342 + math.cos(enemy.animation_timer) * 2 - enemy.ponytail:getWidth(), 51 + math.sin(enemy.animation_timer) * 3 - enemy.ponytail:getHeight(), 0, 2, 2)
